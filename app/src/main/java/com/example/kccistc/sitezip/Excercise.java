...
public class Excercise extends AppCompatActivity implements ExcerciseAdapter.OnItemClickListener{
        ...
        final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonArray = response.getJSONArray("excercise");
                            ...
                            excerciseAdapter = new ExcerciseAdapter(Excercise.this, excerciseItems);
                            recyclerView.setAdapter(excerciseAdapter);
                            excerciseAdapter.setOnItemClickListener(Excercise.this);
