...
public class Etc extends AppCompatActivity implements ExcerciseAdapter.OnItemClickListener{
        ...
        final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonArray = response.getJSONArray("etc");
                            ...
                            excerciseAdapter = new ExcerciseAdapter(Etc.this, excerciseItems);
                            recyclerView.setAdapter(excerciseAdapter);
                            excerciseAdapter.setOnItemClickListener(Etc.this);
