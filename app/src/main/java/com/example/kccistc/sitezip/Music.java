...
public class Music extends AppCompatActivity implements ExcerciseAdapter.OnItemClickListener {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            excerciseAdapter = new ExcerciseAdapter(Music.this, excerciseItems);
                            recyclerView.setAdapter(excerciseAdapter);
                            excerciseAdapter.setOnItemClickListener(Music.this);
