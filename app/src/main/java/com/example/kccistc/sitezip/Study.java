...
public class Study extends AppCompatActivity implements ExcerciseAdapter.OnItemClickListener {
        ...
        final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jsonArray = response.getJSONArray("study");
                            ...
                            excerciseAdapter = new ExcerciseAdapter(Study.this, excerciseItems);
                            recyclerView.setAdapter(excerciseAdapter);
                            excerciseAdapter.setOnItemClickListener(Study.this);
